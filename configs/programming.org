...
** Haskell
   First, the basic haskell mode that other haskell goodies are built on.
   #+BEGIN_SRC emacs-lisp
   ...
   but recent popular ones appear to be [[http://commercialhaskell.github.io/intero/][Intero]] and [[https://github.com/jyp/dante][Dante]]. I'd like to
   try Dante.
